...
class RoITargetLayer(caffe.Layer):
    """
    ...
    def setup(self, bottom, top):
        ...
        top[0].reshape(1, 5)
        # pixel-wise labels of the image containing the rois
    ...
    def forward(self, bottom, top):
        ...
        # pixel-wise image labels
        img_labels = bottom[2].data
...
def _get_bbox_regression_labels(bbox_target_data, num_classes):
    ...
    This function expands those targets into the N-of-4*K representation used
