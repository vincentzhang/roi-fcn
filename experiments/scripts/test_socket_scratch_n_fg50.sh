...
# example: ./experiments/scripts/test_socket_scratch_n_fg50.sh test all 4586 1 16 1
...
LOG="experiments/logs/eval_socket_scratch_n_fg50_1e-05_end2end_${NET}.txt.`date +'%Y-%m-%d_%H-%M-%S'`"
exec &> >(tee -a "$LOG")
