...
LOG="experiments/logs/eval_socket_scratch_n_10_after_roi_end2end_${NET}.txt.`date +'%Y-%m-%d_%H-%M-%S'`"
exec &> >(tee -a "$LOG")
...
#for i in "${ITERATION_LIST[@]}"
  ...
  NET_FINAL="output/socket_scratch_end2end/socket_train/vgg16_detect_socket_scratch_n_10_after_roi_1e-05_iter_${ITER}.caffemodel"
