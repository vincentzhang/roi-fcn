...
LOG="experiments/logs/eval_socket_scratch_end2end_${NET}.txt.`date +'%Y-%m-%d_%H-%M-%S'`"
exec &> >(tee -a "$LOG")
...
#for i in "${ITERATION_LIST[@]}"
  ...
  NET_FINAL="output/socket_scratch_end2end/socket_train/vgg16_detect_socket_scratch_1e-10_iter_${ITER}.caffemodel"
